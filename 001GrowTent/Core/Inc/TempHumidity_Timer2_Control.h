...
#define DHT11_EXPECTED_TRANSITIONS			83U					//Maximum number of edges once DHT11 replies

#define DHT11_SENSOR_1						TIM_CHANNEL_1		//Which channel of timer 2 is the sensor attached to. There are two TempHumidity sensors
#define DHT11_SENSOR_2						TIM_CHANNEL_2		//Which channel of timer 2 is the sensor attached to. There are two TempHumidity sensors
