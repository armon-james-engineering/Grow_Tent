...
/* Private variables ---------------------------------------------------------*/
uint16_t msTimeBaseCount 	= 0;
uint16_t LCDUpdateCount		= 0;
uint16_t sensorUpdateCount	= 0;
uint16_t modeUpdateCount	= 0;

/* Public variables ---------------------------------------------------------*/
extern TIM_HandleTypeDef tempHumidTimer;
extern TIM_HandleTypeDef tim2OC;
extern TIM_HandleTypeDef tim2OP;
extern TIM_HandleTypeDef tim2IC;
extern RTC_HandleTypeDef rtc1;
